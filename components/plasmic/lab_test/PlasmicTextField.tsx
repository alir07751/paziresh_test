...
import Label from "../../Label"; // plasmic-import: 41oH0eXWuuyU/component
import TextInput from "../../TextInput"; // plasmic-import: DJJF_67d65hu/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: Bxy-sF0HVspK/component
import Description from "../../Description"; // plasmic-import: YtfkTYddLs9L/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: PBJYPWxfdZVw/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__j8VrM, {
          [sty.freeBoxiconEnd__j8VrMgTjfZ]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__j8VrMg7UWt]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__j8VrMjAgzF]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___1VNro, {
            [sty.freeBoxiconStart___1VNrOg7UWt]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___1VNrojAgzF]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hrhCv)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__bflSj, {
            [sty.freeBoxiconEnd__bflSjGTjfZ]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__bflSjg7UWt]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__cxAzr)}
                role={"img"}
              />
            ),
