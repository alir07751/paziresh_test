...
import SliderThumb from "../../SliderThumb"; // plasmic-import: hnqhUIRjn58C/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: pC6qv9KjJ7Wk/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox___7PZkj)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__wjsir)}>
        <div
